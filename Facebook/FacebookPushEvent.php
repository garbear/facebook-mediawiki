...
class FacebookPushEvent {
	...
	/**
	 * This static function is called by the extension if push events are
	 * enabled. It checks to make sure that the configured push-events are
	 * valid and then gives them each a chance to initialize.
	 */
